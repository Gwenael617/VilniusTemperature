...
# with(sd2013, plot(date, temperature, xlab="", ylim=c(-25,25),
#                   main = "Temperature à Vilnius \n Septembre à Décembre",  
#                   col="darkseagreen1", pch=8))
# par(new=T)
# with(sd2014, plot(date, temperature, xlab="", ylim=c(-25,25)))
# par(new=T)
# with(sd2015, plot(date, temperature, xlab="", ylim=c(-25,25), 
#                   pch=20, col="red", 
